      ...
      <div className="max-w-screen-lg mx-auto text-white">
        ...
        <div className=" text-center px-4">
          ...
          <p className=" py-5 pb-20">
            ...
            Indian subcontinent. You will find a delectable range of kebabs,
            rice items, curries, and desserts. We are open on all days of the
            week. Whether you want a quick curry takeaway or a lavish dining
            experience for your friends and family, head to our restaurant.{" "}
          </p>
        </div>
      </div>
    </section>
